...
class Born(Model):
    ...
    def get_model(self, incident_field, integral_values):
    ...
    def get_data(self, direct_field, total_forward_field):
...
class PRytov(Model):
    ...
    def get_data(self, total_forward_power, incident_forward_power):
